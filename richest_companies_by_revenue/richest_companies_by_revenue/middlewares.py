...
class RichestCompaniesByRevenueSpiderMiddleware:
...
class RichestCompaniesByRevenueDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
class FakeUserAgentMiddleware:
    ...
    def __init__(self, settings):
        ...
        self.scrapeops_endpoint = settings.get('SCRAPEOPS_FAKE_USER_AGENTS_ENDPOINT', 'http://headers.scrapeops.io/v1/user-agents?')
        self.scrapeops_fake_user_agents_active = settings.get('SCRAPEOPS_FAKE_USER_AGENTS_ENABLED', True)
...
'''class FakeBrowserHeaderAgentMiddleware:
    ...
    def __init__(self, settings):
        self.scrapeops_api_key = settings.get('SCRAPEOPS_API_KEY')
        self.scrapeops_endpoint = settings.get('SCRAPEOPS_FAKE_BROWSER_HEADERS_ENDPOINT', 'http://headers.scrapeops.io/v1/browser-headers')
